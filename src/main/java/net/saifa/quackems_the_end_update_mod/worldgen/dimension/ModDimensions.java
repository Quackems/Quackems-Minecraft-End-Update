package net.saifa.quackems_the_end_update_mod.worldgen.dimension;
...
public class ModDimensions {
    ...
    public static void bootstrapType(BootstapContext<DimensionType> context) {
        context.register(QUACK_DIM_TYPE, new DimensionType(
    ...
    public static void bootstrapStem(BootstapContext<LevelStem> context) {
        ...
        NoiseBasedChunkGenerator wrappedChunkGenerator = new NoiseBasedChunkGenerator(
                new FixedBiomeSource(biomeRegistry.getOrThrow(ModBiomes.END_FOREST)),
                noiseGenSettings.getOrThrow(NoiseGeneratorSettings.AMPLIFIED));

        NoiseBasedChunkGenerator noiseBasedChunkGenerator = new NoiseBasedChunkGenerator(
                MultiNoiseBiomeSource.createFromList(
                        new Climate.ParameterList<>(List.of(Pair.of(
                                        Climate.parameters(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.0F), biomeRegistry.getOrThrow(ModBiomes.END_FOREST)),
                                Pair.of(
        ...
        LevelStem stem = new LevelStem(dimTypes.getOrThrow(ModDimensions.QUACK_DIM_TYPE), noiseBasedChunkGenerator);

        context.register(QUACKDIM_KEY, stem);
    }
}