...
public class ModSurfaceRules {
    private static final SurfaceRules.RuleSource GRASS_BLOCK = makeStateRule(ModBlocks.END_GRASS_BLOCK.get());
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        SurfaceRules.RuleSource grassSurface = SurfaceRules.sequence(SurfaceRules.ifTrue(isAtOrAboveWaterLevel, GRASS_BLOCK), SLUDGE);
