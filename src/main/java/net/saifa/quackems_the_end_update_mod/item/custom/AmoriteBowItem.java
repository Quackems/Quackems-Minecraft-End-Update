...
public class AmoriteBowItem extends ProjectileWeaponItem implements Vanishable{
    ...
    public boolean canApplyAtEnchantingTable(ItemStack stack, Enchantment enchantment) {
        return super.canApplyAtEnchantingTable(stack, (Enchantment) getAllEnchantments(stack));
    }
}
